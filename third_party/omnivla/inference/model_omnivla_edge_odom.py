...
class OmniVLA_edge_odom(BaseModel):
    def __init__(
        self,
        context_size: int = 5,
        len_traj_pred: Optional[int] = 5,
        ...
        super(OmniVLA_edge_odom, self).__init__(context_size, len_traj_pred, learn_angle)
        ...
        if obs_encoder.split("-")[0] == "efficientnet":
            ...
            self.goal_encoder = EfficientNet.from_name("efficientnet-b0", in_channels=3) # odom map (single 3ch image)
